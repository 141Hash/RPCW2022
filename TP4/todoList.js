...
function geraPagPrincipal(tarefas, tarefa){
    let realizadas = [];
    let naoRealizadas = [];
    ...
    <html>
        <head>
            <title>ToDo List Wev Page</title>
            <meta charset="utf-8"/>
                ...
                if((req.url == "/") || (req.url == "/tarefas")){
                    axios.get("http://localhost:3000/tarefas")
                        .then(response => {
                            ...
                            res.write(geraPagPrincipal(tarefas, {}))
                            res.end()
                        })
                        .catch(function(erro){
                            res.writeHead(200, {'Content-Type': 'text/html;charset=utf-8'})
                    ...
                    .then(respTarefas => {
                        ...
                        .then(respTarefa => {
                            res.writeHead(200, {'Content-Type':'text/html;charset=utf-8'})
                            res.write(geraPagPrincipal(respTarefas.data, (respTarefa.data)[0]))
                            res.end()
                        })
                        .catch(error => {
                            res.writeHead(200, {'Content-Type':'text/html;charset=utf-8'})

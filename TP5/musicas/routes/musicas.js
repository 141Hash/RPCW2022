...
//Obter página individual de música por ID
router.get('/:id', function(req, res, next) {
    var idMusica = req.params.id;
    axios
      .get("http://localhost:3000/musicas?id=" + idMusica)
      .then((response) => {
...
//Obter todas as músicas de uma província
